...
(function ($) {
  ...
  const curvedTextAnimation = (target, options) => {
    ...
    const curveTextchar = target.querySelectorAll(
  ...
  const slideTextAnimation = (target, options) => {
    ...
    let slide_anime = anime.createTimeline();
    slide_anime
      .add(current_anime_text.querySelectorAll("div"), {
        scaleX: [0, 1],
        duration: speed + 500,
        ease: "inOutCubic",
        onComplete: function () {
      ...
      .add(
        target.querySelectorAll(".anime-text > .word > .char"),
        {
          ease: "outQuint",
          delay:
  ...
  const smoothWaveTextAnimation = (target, options) => {
    ...
    const smoothWaveTextchar = target.querySelectorAll(
      ".anime-text > .word > .char"
    );
  ...
  const rotateTextAnimation = (target, options) => {
    ...
    const rotateTextchar = target.querySelectorAll(
      ".anime-text > .word > .char"
    );
  ...
  const zoomTextAnimation = (target, options) => {
    ...
    movingLetter2
      ...
      .add(
        target.querySelectorAll(".anime-text > .word"),
        {
          opacity: content.length > 1 ? 0 : 1,
          duration: 1000,
          ease: "outExpo",
  ...
  const rubberbandTextAnimation = (target, options) => {
    ...
    const rubberbandchars = target.querySelectorAll(
      ".anime-text > .word > .char"
    );
  ...
  instagramWrapperItems.forEach(function (instagramWrapperItem) {
    var token =
        "IGQWROLXF6d1l6anM0WU81SkhHdDFsSkZAUNS1xTHdPSm1naXR3UkQzd01jczR6X1Q4cGdsdTVVMjRUX3NNc0RMOTRZAbVdQSjdpMUZAxYjNpc1puc18ycDI1eUZAoaUlxSm5TbW0tOExiUDVpMm12T0hLai10MUxqanMZD",
  ...
  $(document).ready(function () {
    ...
    $(".cards").each(function () {
      ...
      const topDataSpace =
        parseInt($cardsContainer.attr("data-top-space")) || 0;
      const topPadding =
        parseInt($cardsContainer.attr("data-top-padding")) || 0;
